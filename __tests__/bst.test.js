...
describe('binarySearchTree', () => {
  ...
  test('it should add a child node to the left of the root', () => {
    let bst = new BST();
  ...
  test('it should a child to the left of a child node', () => {
    let bst = new BST();
    let rootNode = new BSTNode(36);
    bst.insertNode(rootNode);
  ...
  test('it should a child to the right of a child node', () => {
    let bst = new BST();
    let rootNode = new BSTNode(36);
    bst.insertNode(rootNode);
